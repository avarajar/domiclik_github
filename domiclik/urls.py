...
urlpatterns = patterns('',
    ...
    url(r'^restaurantes/(?P<slug>[-\d]+)/$', 'Administrador.views.restaurantes_ciudad', name='restaurantes_ciudad'),
    ...
    url(r'^menu/(\d+)/(\d+)/(\d+)/$', 'Administrador.views.menu_ciudad_sector', name='menu_ciudad_sector'),
    url(r'^menu/(\d+)/(\d+)/(\d+)/(\d+)$', 'Administrador.views.menu_ciudad_sector_tipo', name='menu_ciudad_sector_tipo'),
