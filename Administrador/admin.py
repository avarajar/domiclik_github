...
admin.site.register(TituloAdicionalDos)
admin.site.register(TituloAdicionalTres)
admin.site.register(AdiUnico)
admin.site.register(AdiUnicoDos)
admin.site.register(AdiUnicoTres)
admin.site.register(Adicionale)
admin.site.register(AdicionalDos)
admin.site.register(AdicionalTres)
