...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Menuesp.categoria'
        db.add_column(u'Administrador_menuesp', 'categoria',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Administrador.Categoria']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Menuesp.categoria'
        db.delete_column(u'Administrador_menuesp', 'categoria_id')
