...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Restaurante.tipo'
        db.delete_column(u'Administrador_restaurante', 'tipo_id')

        # Adding M2M table for field tipo on 'Restaurante'
        m2m_table_name = db.shorten_name(u'Administrador_restaurante_tipo')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('restaurante', models.ForeignKey(orm[u'Administrador.restaurante'], null=False)),
            ('tipo', models.ForeignKey(orm[u'Administrador.tipo'], null=False))
        ))
        db.create_unique(m2m_table_name, ['restaurante_id', 'tipo_id'])


    def backwards(self, orm):
        # Adding field 'Restaurante.tipo'
        db.add_column(u'Administrador_restaurante', 'tipo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Administrador.Tipo']),
                      keep_default=False)

        # Removing M2M table for field tipo on 'Restaurante'
        db.delete_table(db.shorten_name(u'Administrador_restaurante_tipo'))
