...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Restaurante.entrega'
        db.add_column(u'Administrador_restaurante', 'entrega',
    ...
    def backwards(self, orm):
        # Deleting field 'Restaurante.entrega'
        db.delete_column(u'Administrador_restaurante', 'entrega')
