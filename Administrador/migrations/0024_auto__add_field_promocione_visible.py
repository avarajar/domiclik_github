...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Promocione.visible'
        db.add_column(u'Administrador_promocione', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Promocione.visible'
        db.delete_column(u'Administrador_promocione', 'visible')
