...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Categoria.imagen_categoria'
        db.add_column(u'Administrador_categoria', 'imagen_categoria',
                      self.gf('django.db.models.fields.files.ImageField')(default=0, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Categoria.imagen_categoria'
        db.delete_column(u'Administrador_categoria', 'imagen_categoria')
