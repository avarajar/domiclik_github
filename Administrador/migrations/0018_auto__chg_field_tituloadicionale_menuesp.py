...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TituloAdicionale.menuesp'
        db.alter_column(u'Administrador_tituloadicionale', 'menuesp_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['Administrador.Menuesp']))

    def backwards(self, orm):

        # Changing field 'TituloAdicionale.menuesp'
        db.alter_column(u'Administrador_tituloadicionale', 'menuesp_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Administrador.Menuesp']))
