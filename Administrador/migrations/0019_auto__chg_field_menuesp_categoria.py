...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Menuesp.categoria'
        db.alter_column(u'Administrador_menuesp', 'categoria_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['Administrador.Categoria']))

    def backwards(self, orm):

        # Changing field 'Menuesp.categoria'
        db.alter_column(u'Administrador_menuesp', 'categoria_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Administrador.Categoria']))
