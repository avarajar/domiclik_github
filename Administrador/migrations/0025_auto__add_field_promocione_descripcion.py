...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Promocione.descripcion'
        db.add_column(u'Administrador_promocione', 'descripcion',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Promocione.descripcion'
        db.delete_column(u'Administrador_promocione', 'descripcion')
