...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Pedido'
        db.create_table(u'Administrador_pedido', (
            ...
            ('barrio', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('direccion', self.gf('django.db.models.fields.TextField')()),
            ('restaurant', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('pedido_completo', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'Administrador', ['Pedido'])


    def backwards(self, orm):
        # Deleting model 'Pedido'
        db.delete_table(u'Administrador_pedido')
