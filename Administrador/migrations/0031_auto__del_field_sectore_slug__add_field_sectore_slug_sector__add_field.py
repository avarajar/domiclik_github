...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sectore.slug'
        db.delete_column(u'Administrador_sectore', 'slug')

        # Adding field 'Sectore.slug_sector'
        db.add_column(u'Administrador_sectore', 'slug_sector',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Tipo.slug_tipo'
        db.add_column(u'Administrador_tipo', 'slug_tipo',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Deleting field 'Restaurante.tiempo'
        db.delete_column(u'Administrador_restaurante', 'tiempo')

        # Adding field 'Restaurante.slug_restaurant'
        db.add_column(u'Administrador_restaurante', 'slug_restaurant',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=250, blank=True),
                      keep_default=False)


        # Changing field 'Restaurante.precio_domicilio'
        db.alter_column(u'Administrador_restaurante', 'precio_domicilio', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):
        # Adding field 'Sectore.slug'
        db.add_column(u'Administrador_sectore', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Deleting field 'Sectore.slug_sector'
        db.delete_column(u'Administrador_sectore', 'slug_sector')

        # Deleting field 'Tipo.slug_tipo'
        db.delete_column(u'Administrador_tipo', 'slug_tipo')

        # Adding field 'Restaurante.tiempo'
        db.add_column(u'Administrador_restaurante', 'tiempo',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=60),
                      keep_default=False)

        # Deleting field 'Restaurante.slug_restaurant'
        db.delete_column(u'Administrador_restaurante', 'slug_restaurant')


        # Changing field 'Restaurante.precio_domicilio'
        db.alter_column(u'Administrador_restaurante', 'precio_domicilio', self.gf('django.db.models.fields.CharField')(max_length=60))
