...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sectore.ciudad'
        db.add_column(u'Administrador_sectore', 'ciudad',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Administrador.Ciudade']),
                      keep_default=False)


        # Changing field 'Ciudade.slug'
        db.alter_column(u'Administrador_ciudade', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=250))

    def backwards(self, orm):
        # Deleting field 'Sectore.ciudad'
        db.delete_column(u'Administrador_sectore', 'ciudad_id')


        # Changing field 'Ciudade.slug'
        db.alter_column(u'Administrador_ciudade', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100))
