...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TituloAdicionale.restaurant'
        db.add_column(u'Administrador_tituloadicionale', 'restaurant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Administrador.Restaurante']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TituloAdicionale.restaurant'
        db.delete_column(u'Administrador_tituloadicionale', 'restaurant_id')
