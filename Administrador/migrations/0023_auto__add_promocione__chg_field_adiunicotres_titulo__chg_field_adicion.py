...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Promocione'
        db.create_table(u'Administrador_promocione', (
        ...
        db.send_create_signal(u'Administrador', ['Promocione'])


        # Changing field 'AdiUnicoTres.titulo'
        db.alter_column(u'Administrador_adiunicotres', 'titulo_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['Administrador.TituloAdicionalTres']))

        # Changing field 'AdicionalTres.titulo'
        db.alter_column(u'Administrador_adicionaltres', 'titulo_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['Administrador.TituloAdicionalTres']))

        # Changing field 'AdiUnicoDos.titulo'
        db.alter_column(u'Administrador_adiunicodos', 'titulo_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['Administrador.TituloAdicionalDos']))

        # Changing field 'AdicionalDos.titulo'
        db.alter_column(u'Administrador_adicionaldos', 'titulo_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['Administrador.TituloAdicionalDos']))

    def backwards(self, orm):
        # Deleting model 'Promocione'
        db.delete_table(u'Administrador_promocione')


        # Changing field 'AdiUnicoTres.titulo'
        db.alter_column(u'Administrador_adiunicotres', 'titulo_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['Administrador.TituloAdicionale']))

        # Changing field 'AdicionalTres.titulo'
        db.alter_column(u'Administrador_adicionaltres', 'titulo_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['Administrador.TituloAdicionale']))

        # Changing field 'AdiUnicoDos.titulo'
        db.alter_column(u'Administrador_adiunicodos', 'titulo_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['Administrador.TituloAdicionale']))

        # Changing field 'AdicionalDos.titulo'
        db.alter_column(u'Administrador_adicionaldos', 'titulo_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['Administrador.TituloAdicionale']))
